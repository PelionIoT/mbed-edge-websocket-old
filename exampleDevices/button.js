...
EdgeJsonRpcExample.prototype._createDeviceParams = function(buttonVal) {
    // Values are always Base64 encoded strings.
    let button = Buffer.allocUnsafe(4);
    button.writeInt32BE(buttonVal);
    button = button.toString('base64');

    // An IPSO/LwM2M button
    params = {
        deviceId: 'ExampleButton-1',
        objects: [{
            objectId: 3347,
            objectInstances: [{
                objectInstanceId: 0,
...
EdgeJsonRpcExample.prototype.registerExampleDevice = async function() {
    ...
    return new Promise((resolve, reject) => {
        ...
        params = self._createDeviceParams(0 /* pressed false */);
...
EdgeJsonRpcExample.prototype.unregisterExampleDevice = async function() {
    ...
    return new Promise((resolve, reject) => {
        ...
        self.client.send('device_unregister', {deviceId: 'ExampleButton-1'},
            function(error, response) {
                clearTimeout(timeout);
                if (!error) {
                    resolve(response);
...
EdgeJsonRpcExample.prototype.updateExampleDeviceResources = async function() {
    ...
    return new Promise((resolve, reject) => {
        ...
        params = self._createDeviceParams(1 /* pressed true */);
...
EdgeJsonRpcExample.prototype.exposeWriteMethod = function() {
    ...
    self.client.expose('write', (params, response) => {
        ...
        console.log(params);
        let value = new Buffer.from(params.value, 'base64').readInt32BE();
